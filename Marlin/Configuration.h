...
#define PRO_B_WITH_LEADSCREW
  ...
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.94, 79.94, 395.06, 95.45 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 75, 2000 }
...
//#define PROBE_MANUALLY // Manuelle Messung ohne Sonde
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 27, -2 }
